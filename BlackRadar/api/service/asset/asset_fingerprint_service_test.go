...
func TestBuildAssetFingerprintUsesExplicitHints(t *testing.T) {
	asset := model.Asset{
		...
		Type:            "Laptop",
		OperatingSystem: fingerprintPtrString("Windows 11 Pro"),
	}
...
func TestBuildAssetFingerprintParsesSentenceStyleHints(t *testing.T) {
	asset := model.Asset{
		Name:            "Chrome Desktop",
		Type:            "Desktop",
		OperatingSystem: fingerprintPtrString("Windows 11"),
	}
...
func TestBuildAssetFingerprintParsesPackageFromProjectSentence(t *testing.T) {
	asset := model.Asset{
		Name:            "Linux Server",
		Type:            "Server",
		OperatingSystem: fingerprintPtrString("Linux"),
	}
...
func fingerprintPtrString(value string) *string {
	return &value
}
